...
| `core/story-api-migration` | migration table ordering, applicability thresholds, representative text rewrite chains, synthetic project IO round-trip, synthetic resource IO round-trip, and player/export JSON resource reads |
