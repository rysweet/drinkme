...
| `netbeans` | generated Alice-to-Java launcher, project template archive contents, main-class alignment, generated project metadata renaming, synthetic Alice project source generation, and generated resource export foothold |
...
- The NetBeans slices cover launcher generation, template archive shape, generated project metadata, minimal Alice-project-to-Java source generation, and a synthetic generated-resource path. They do not yet cover full wizard execution, formatted output, generated-source compilation, palette/completion behavior, or NBM package behavior.
