...
| `core/story-api-migration` | migration table ordering, applicability thresholds, representative text rewrite chains, synthetic project IO round-trip, synthetic resource IO round-trip, player/export JSON resource reads, JSON archive future-version detection, and JSON player resource entry safety |
