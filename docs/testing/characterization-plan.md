...
| `netbeans` | generated Alice-to-Java launcher, project template archive contents, main-class alignment, generated project metadata renaming, and synthetic Alice project source generation |
...
- The NetBeans slices cover launcher generation, template archive shape, generated project metadata, and minimal Alice-project-to-Java source generation. They do not yet cover full wizard execution, formatted output, generated-source compilation, palette/completion behavior, or NBM package behavior.
