...
- Current test coverage is very small relative to the codebase: roughly 4,336 tracked production Java files and 18 Java test files after the first three modernization slices.
