...
- Current test coverage is very small relative to the codebase: thousands of tracked production Java files and 27 Java test files after the first thirty-four modernization slices.
