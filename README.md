...
| Build eatme into a comparison test runner | eatme now has target setup, comparison reports, scorecards, path checks, lesson-session checks, readiness checks, a first-lesson readiness sequence, Alice window activation, a machine-readable place-object no-go probe, the exact missing object-placement affordance, an Alice-side command-hook contract, consumption of valid object-placement proof, action-level reporting for mixed first-lesson results, a window-targeting fallback for bare Xvfb runs, and a machine-readable `edit-procedure-or-code-block` no-go contract after object placement passes in [PR #56](https://github.com/rysweet/eatme/pull/56), [PR #57](https://github.com/rysweet/eatme/pull/57), [PR #58](https://github.com/rysweet/eatme/pull/58), [PR #59](https://github.com/rysweet/eatme/pull/59), [PR #60](https://github.com/rysweet/eatme/pull/60), [PR #61](https://github.com/rysweet/eatme/pull/61), [PR #62](https://github.com/rysweet/eatme/pull/62), [PR #63](https://github.com/rysweet/eatme/pull/63), [PR #64](https://github.com/rysweet/eatme/pull/64), [PR #65](https://github.com/rysweet/eatme/pull/65), [PR #66](https://github.com/rysweet/eatme/pull/66), [PR #67](https://github.com/rysweet/eatme/pull/67), [PR #68](https://github.com/rysweet/eatme/pull/68), [PR #69](https://github.com/rysweet/eatme/pull/69), [PR #70](https://github.com/rysweet/eatme/pull/70), [PR #71](https://github.com/rysweet/eatme/pull/71), and [PR #72](https://github.com/rysweet/eatme/pull/72). | eatme can compare startup behavior, check first-lesson evidence, find and focus the Alice main window under bare Xvfb, ask Alice to prove object placement when the hook exists, and then name the next missing contract: `edit-procedure-or-code-block`. It does not yet edit code, run worlds, save projects, grade work, or run a full teacher/student lesson. |
...
| Object placement hook | eatme needs Alice to make one deterministic first-lesson change before it can compare more than startup/readiness. | RabbitHole now exposes `tools/eatme-place-object`. It adds a Bunny-backed `SBiped` field to the starter scene, writes a modified project, returns non-empty placement/diff proof files, and now keeps stdout parseable as hook JSON even when Alice migration code prints progress text. | [RabbitHole object placement hook #143](https://github.com/rysweet/RabbitHole/pull/143), [stdout contract fix #144](https://github.com/rysweet/RabbitHole/pull/144), [eatme proof consumer #69](https://github.com/rysweet/eatme/pull/69), [eatme action progress #70](https://github.com/rysweet/eatme/pull/70), [object-placement hook journal](docs/atlas/journal/0069-object-placement-hook-implementation.md), [hook progress journal](docs/atlas/journal/0070-object-placement-progress-evidence.md) | This is backend Bunny placement proof only. It is not gallery clicking, procedure editing, world run, desktop save, grading, or full lesson consumption. |
...
xychart-beta
  ...
  x-axis ["Save/load", "Export", "Project files", "Runtime", "Old files", "Object hook", "Large classes", "Coverage"]
  y-axis "Coverage level" 0 --> 10
  bar [7, 8, 6, 7, 6, 7, 5, 2]
```
...
| Original-vs-RabbitHole comparison | [comparison target registry](https://github.com/rysweet/eatme/blob/master/assets/alice-comparison-targets.yaml) | Runs checks for target setup, comparison reports, timing, lesson-session evidence, readiness evidence, the first-lesson readiness sequence, Alice window discovery and focus, blocked object placement when the hook is missing, proof consumption when the hook exists, and action-level progress. | [PR #56](https://github.com/rysweet/eatme/pull/56), [#57](https://github.com/rysweet/eatme/pull/57), [#58](https://github.com/rysweet/eatme/pull/58), [#59](https://github.com/rysweet/eatme/pull/59), [#60](https://github.com/rysweet/eatme/pull/60), [#61](https://github.com/rysweet/eatme/pull/61), [#62](https://github.com/rysweet/eatme/pull/62), [#63](https://github.com/rysweet/eatme/pull/63), [#64](https://github.com/rysweet/eatme/pull/64), [#65](https://github.com/rysweet/eatme/pull/65), [#66](https://github.com/rysweet/eatme/pull/66), [#67](https://github.com/rysweet/eatme/pull/67), [#68](https://github.com/rysweet/eatme/pull/68), [#69](https://github.com/rysweet/eatme/pull/69), [#70](https://github.com/rysweet/eatme/pull/70), [#71](https://github.com/rysweet/eatme/pull/71), [#72](https://github.com/rysweet/eatme/pull/72) | Implement the `edit-procedure-or-code-block` proof contract, then add run and save proof. |
| First Alice lessons | [first-lessons-real-ui-actions](https://github.com/rysweet/eatme/blob/master/assets/scenarios/eatme/first-lessons-real-ui-actions.yaml), [building-a-scene-first-world](https://github.com/rysweet/eatme/blob/master/assets/scenarios/eatme/building-a-scene-first-world.yaml), [code-editor-first-run](https://github.com/rysweet/eatme/blob/master/assets/scenarios/eatme/code-editor-first-run.yaml) | Teacher and student test files describe visible actions, reflections, expected files, readiness checks, Alice window activation, object-placement proof, action-level progress, and the remaining edit/run/save blockers. Adapter files are generated. | Scenario validation, adapter freshness checks, readiness checks, the first-lesson readiness sequence, Alice window activation, the place-object no-go probe, the missing-affordance contract, the hook contract, the hook-proof consumer, action-level reporting, the bare-Xvfb window fallback, and the `edit-procedure-or-code-block` no-go contract pass after [PR #69](https://github.com/rysweet/eatme/pull/69), [PR #70](https://github.com/rysweet/eatme/pull/70), [PR #71](https://github.com/rysweet/eatme/pull/71), and [PR #72](https://github.com/rysweet/eatme/pull/72). A real local run reached `blocked_until_ui_automation`: original Alice lacked object placement, while RabbitHole passed object placement and stopped at edit/run/save. | Code editing, world run, and project save automation are still intentionally limited. |
