...
| Build eatme into a comparison test runner | eatme now has target setup, comparison reports, scorecards, path checks, lesson-session checks, readiness checks, a first-lesson readiness sequence, Alice window activation, a machine-readable place-object no-go probe, the exact missing object-placement affordance, an Alice-side command-hook contract, consumption of valid object-placement proof, action-level reporting for mixed first-lesson results, a window-targeting fallback for bare Xvfb runs, a machine-readable `edit-procedure-or-code-block` no-go contract, consumption of valid edit proof after object placement, a `run-world` no-go contract after edit proof, consumption of valid run-world proof, consumption of valid project-save proof, Ctrl+S desktop input dispatch, gated Ctrl+F5 Run shortcut dispatch, a Run-window observation probe, and stale display cleanup in [PR #56](https://github.com/rysweet/eatme/pull/56), [PR #57](https://github.com/rysweet/eatme/pull/57), [PR #58](https://github.com/rysweet/eatme/pull/58), [PR #59](https://github.com/rysweet/eatme/pull/59), [PR #60](https://github.com/rysweet/eatme/pull/60), [PR #61](https://github.com/rysweet/eatme/pull/61), [PR #62](https://github.com/rysweet/eatme/pull/62), [PR #63](https://github.com/rysweet/eatme/pull/63), [PR #64](https://github.com/rysweet/eatme/pull/64), [PR #65](https://github.com/rysweet/eatme/pull/65), [PR #66](https://github.com/rysweet/eatme/pull/66), [PR #67](https://github.com/rysweet/eatme/pull/67), [PR #68](https://github.com/rysweet/eatme/pull/68), [PR #69](https://github.com/rysweet/eatme/pull/69), [PR #70](https://github.com/rysweet/eatme/pull/70), [PR #71](https://github.com/rysweet/eatme/pull/71), [PR #72](https://github.com/rysweet/eatme/pull/72), [PR #73](https://github.com/rysweet/eatme/pull/73), [PR #74](https://github.com/rysweet/eatme/pull/74), [PR #75](https://github.com/rysweet/eatme/pull/75), [PR #76](https://github.com/rysweet/eatme/pull/76), [PR #77](https://github.com/rysweet/eatme/pull/77), [PR #78](https://github.com/rysweet/eatme/pull/78), [PR #79](https://github.com/rysweet/eatme/pull/79), and [PR #80](https://github.com/rysweet/eatme/pull/80). Real runs now show RabbitHole passing window focus, Ctrl+S input dispatch, gated Ctrl+F5 Run shortcut dispatch, object placement, backend procedure edit, bounded run-world proof, and backend project-save proof, while also recording that Alice's license agreement window blocks Run-window observation. | eatme can compare startup behavior, check first-lesson evidence, find and focus the Alice main window under bare Xvfb, dispatch real desktop save and Run shortcuts as input evidence, record the license agreement as the next Run-window blocker, clean stale X display files left by crashed runs, ask Alice to prove object placement when the hook exists, ask RabbitHole to prove one backend procedure edit, ask RabbitHole to prove bounded headless world execution, and ask RabbitHole to prove a saved `.a3p` round trip. It still does not prove desktop Run-window completion, prove the desktop save menu completed a save, grade work, or run a full teacher/student lesson. |
...
xychart-beta
  ...
  x-axis ["Save/load", "Export", "Project files", "Runtime", "Old files", "Lesson hooks", "Large classes", "Coverage"]
  y-axis "Coverage level" 0 --> 10
  bar [7, 8, 6, 7, 6, 9, 5, 2]
```
