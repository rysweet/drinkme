...
| Build eatme into a comparison test runner | eatme now has target setup, comparison reports, scorecards, path checks, lesson-session checks, readiness checks, a first-lesson readiness sequence, Alice window activation, a machine-readable place-object no-go probe, the exact missing object-placement affordance, an Alice-side command-hook contract, consumption of valid object-placement proof, action-level reporting for mixed first-lesson results, a window-targeting fallback for bare Xvfb runs, a machine-readable `edit-procedure-or-code-block` no-go contract, consumption of valid edit proof after object placement, and a `run-world` no-go contract after edit proof in [PR #56](https://github.com/rysweet/eatme/pull/56), [PR #57](https://github.com/rysweet/eatme/pull/57), [PR #58](https://github.com/rysweet/eatme/pull/58), [PR #59](https://github.com/rysweet/eatme/pull/59), [PR #60](https://github.com/rysweet/eatme/pull/60), [PR #61](https://github.com/rysweet/eatme/pull/61), [PR #62](https://github.com/rysweet/eatme/pull/62), [PR #63](https://github.com/rysweet/eatme/pull/63), [PR #64](https://github.com/rysweet/eatme/pull/64), [PR #65](https://github.com/rysweet/eatme/pull/65), [PR #66](https://github.com/rysweet/eatme/pull/66), [PR #67](https://github.com/rysweet/eatme/pull/67), [PR #68](https://github.com/rysweet/eatme/pull/68), [PR #69](https://github.com/rysweet/eatme/pull/69), [PR #70](https://github.com/rysweet/eatme/pull/70), [PR #71](https://github.com/rysweet/eatme/pull/71), [PR #72](https://github.com/rysweet/eatme/pull/72), [PR #73](https://github.com/rysweet/eatme/pull/73), and [PR #74](https://github.com/rysweet/eatme/pull/74). A real run, `edit-proof-20260506075255`, now shows RabbitHole passing window focus, object placement, and backend procedure edit before stopping at run/save. | eatme can compare startup behavior, check first-lesson evidence, find and focus the Alice main window under bare Xvfb, ask Alice to prove object placement when the hook exists, ask RabbitHole to prove one backend procedure edit, and now name the missing world-run proof precisely. It still does not run worlds, save projects, grade work, or run a full teacher/student lesson. |
