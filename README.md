...
| Build eatme into a comparison test runner | eatme now has target setup, comparison reports, scorecards, path checks, lesson-session checks, readiness checks, a first-lesson readiness sequence, Alice window activation, a machine-readable place-object no-go probe, the exact missing object-placement affordance, an Alice-side command-hook contract, and consumption of valid object-placement proof in [PR #56](https://github.com/rysweet/eatme/pull/56), [PR #57](https://github.com/rysweet/eatme/pull/57), [PR #58](https://github.com/rysweet/eatme/pull/58), [PR #59](https://github.com/rysweet/eatme/pull/59), [PR #60](https://github.com/rysweet/eatme/pull/60), [PR #61](https://github.com/rysweet/eatme/pull/61), [PR #62](https://github.com/rysweet/eatme/pull/62), [PR #63](https://github.com/rysweet/eatme/pull/63), [PR #64](https://github.com/rysweet/eatme/pull/64), [PR #65](https://github.com/rysweet/eatme/pull/65), [PR #66](https://github.com/rysweet/eatme/pull/66), [PR #67](https://github.com/rysweet/eatme/pull/67), [PR #68](https://github.com/rysweet/eatme/pull/68), and [PR #69](https://github.com/rysweet/eatme/pull/69). | eatme can compare startup behavior, check first-lesson evidence, activate the Alice window, ask Alice to prove object placement when the hook exists, and separate that progress from the still-missing edit/run/save steps. It does not yet edit code, run worlds, save projects, grade work, or run a full teacher/student lesson. |
...
| Object placement hook | eatme needs Alice to make one deterministic first-lesson change before it can compare more than startup/readiness. | RabbitHole now exposes `tools/eatme-place-object`. It adds a Bunny-backed `SBiped` field to the starter scene, writes a modified project, and returns non-empty placement/diff proof files. | [RabbitHole object placement hook #143](https://github.com/rysweet/RabbitHole/pull/143), [eatme proof consumer #69](https://github.com/rysweet/eatme/pull/69), [object-placement hook journal](docs/atlas/journal/0069-object-placement-hook-implementation.md) | This is backend Bunny placement proof only. It is not gallery clicking, procedure editing, world run, desktop save, grading, or full lesson consumption. |
